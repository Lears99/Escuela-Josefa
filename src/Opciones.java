...
public class Opciones extends javax.swing.JFrame {
    ...
    public Opciones() {
        ...
        holder = new TextPrompt("Introduzca nombre de usuario", Nom_Usuario);
        holder = new TextPrompt("Introduzca la contraseña", Contraseña);
    ...
    private void initComponents() {
        ...
        TituloPanel.setText("Registre Usuario");

        jLabel2.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel2.setText("Nombre del Usuario");

        Nom_Usuario.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        MenuDesplegableLayout.setHorizontalGroup(
            ...
            .addComponent(TituloPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 286, Short.MAX_VALUE)
            .addComponent(Nom_Usuario, javax.swing.GroupLayout.Alignment.TRAILING)
            ...
            .addGroup(PanelTablaLayout.createSequentialGroup()
                .addGroup(PanelTablaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(PanelTablaLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(T_Buscar, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(MenuDesplegable, javax.swing.GroupLayout.DEFAULT_SIZE, 319, Short.MAX_VALUE)
    ...
    private void tblAlumnosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblAlumnosMouseClicked
        ...
        try {
            ...
            String name = tblAlumnos.getValueAt(fila, 0).toString();

            ps = cin.prepareStatement("SELECT Nombre, Contraseña FROM Logins WHERE Nombre=?");
            ps.setString(1, name);
            res = ps.executeQuery();

            while (res.next()) {
                Nom_Usuario.setText(String.valueOf(name));
                Contraseña.setText(res.getString("Contraseña"));
    ...
    private void B_BuscarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B_BuscarDatosActionPerformed
        // TODO add your handling code here:
        try {
            ps = cin.prepareStatement("SELECT * FROM Logins WHERE Nombre = ?");
            ...
            if (rs.next()) {
                ...
                ps = cin.prepareStatement("SELECT Nombre FROM Logins WHERE Nombre=?");
    ...
    void Registrar() {
        ...
        try {
            ...
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, "Usuario Repetido, Cambielo");
            } else {

                ps = cin.prepareStatement("INSERT INTO Logins (Nombre, Contraseña)VALUES (?,?)");
                ps.setString(1, Nom_Usuario.getText());
                ps.setString(2, Contraseña.getText());

                ps.executeUpdate();

                JOptionPane.showMessageDialog(this, "Dato Guardado", "Usuario", JOptionPane.QUESTION_MESSAGE);
                Limpiar();
            }
           ...
           if(registro > 0){
            ...
            JOptionPane.showMessageDialog(this, "Dato No Guardado", "Usuario", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public void CargarArticulo() {
        DefaultTableModel modelo = (DefaultTableModel) tblAlumnos.getModel();
        modelo.setRowCount(0);
        res = conexion.Consulta("SELECT Nombre FROM Logins");
    ...
    void Modificar() {
        try {
            ps = cin.prepareStatement("UPDATE Logins SET Contraseña=? WHERE Nombre=?");
            ps.setString(1, Contraseña.getText());
            ps.setString(2, Nom_Usuario.getText());
            ps.executeUpdate();
    ...
    void Eliminar() {
        try {
            ...
            ps = cin.prepareStatement("DELETE FROM Logins WHERE Nombre=?");
            ps.setString(1, Nom_Usuario.getText());
            ps.executeUpdate();

            JOptionPane.showMessageDialog(this, "Usuario Eliminado", "Opciones", JOptionPane.QUESTION_MESSAGE);
            Limpiar();

        }catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Usuario No Guardado", "Opciones", JOptionPane.ERROR_MESSAGE);
        }
