...
public class General extends javax.swing.JFrame {
    ...
    public General() {
        ...
        holder = new TextPrompt("Introduzca las asistencias del trabajador", T_Asis);
    ...
    private void initComponents() {
        ...
        tblAlumnos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CURP", "Cargo", "Nombre", "Edad", "Telefono", "Correo", "Direccion", "Asistencias"
            }
        ) {
    ...
    private void tblAlumnosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblAlumnosMouseClicked
        ...
        try {
            ...
            ps = cin.prepareStatement("SELECT CURP, Cargo, Nombre, Edad, Telefono, Correo, Direccion, Asistencias FROM PersonalGeneral WHERE CURP=?");
            ps.setString(1, curp);
            res = ps.executeQuery();

            while (res.next()) {
                T_Curp.setText(String.valueOf(curp));
                T_Cargo.setText(res.getString("Cargo"));
    ...
    void Modificar() {
        try {
            ...
            ps.setString(1, T_Cargo.getText());
